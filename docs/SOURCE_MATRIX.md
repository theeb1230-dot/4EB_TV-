...
| 03 | ARB-S33-3-main | Provider / Reference | Clean-room capability/catalog/metadata/stream boundaries only; unresolved root/per-target rights and runtime targets fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 08 | kiro-drama-main | Provider / Reference | Clean-room capability/catalog/metadata/stream boundaries only; unresolved root/per-target rights and runtime targets fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 14 | NuvioStreamsAddon-master | Provider / Engine / Reference | Clean-room independent capability declarations, normalized boundaries and failure isolation only; unresolved root/per-source rights and runtime targets fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 19 | TRK_S-main | Provider / Reference | Turkish Stremio capability declarations and catalog/metadata/stream separation only; unresolved rights/license/targets fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 24 | stremio-akwam.X-main | Provider / Engine / Reference | Clean-room cancellable/timeout-bounded transport and capability/failure isolation only; unresolved endpoints/rights/license fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 26 | Cannels-arap-streem-main | Provider / Data / Reference | Canonical Arabic channel taxonomy/EPG contracts only; unresolved stream rights/license fail closed; private credentials/playlists excluded | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
...
| 30 | kiro-main | Provider / Reference | Clean-room capability/catalog/metadata/stream boundaries only; unresolved root/per-target rights and runtime targets fail closed | AUDIT COMPLETE — CONTRACT_REFERENCE / PROVIDER_PENDING |
