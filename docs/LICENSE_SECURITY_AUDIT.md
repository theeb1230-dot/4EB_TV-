...
- **cinextma:** Experience-reference only until root license, dependency, asset provenance, network/config and player evidence closes. Supabase presence does not authorize API use or make cloud services mandatory.
