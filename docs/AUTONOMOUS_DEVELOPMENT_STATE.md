...
- Exact current `main` after merge and this governance refresh: `52e1a0c2f0b3d1e9dcb1b2f6d6f7c1a62c1c4d9a`.
- Open PRs after merge: none verified before this refresh; this branch is now the only active change.
...
## Closed this run
- Re-read repository metadata, exact `main`, open PRs, branches, and current workflow availability.
- Confirmed the previous state file was stale: it reported `8e38c56ef42ad7f9f86b9c6a4917502610e51f23`, while GitHub `main` points to the later governance-refresh commit.
...
6. Merge this governance branch only after its exact-head CI is green and the branch is mergeable.
### P1
...
## Next targets
1. Verify exact-head CI for this governance refresh branch, then merge only with expected-head protection.
