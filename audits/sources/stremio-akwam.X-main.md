...
Python/FastAPI Stremio-oriented backend; Provider/Reference; inspect API contracts, async/error handling, license and lawful-access boundaries; compare concepts only with 4BA Provider SDK.
